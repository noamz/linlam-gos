# Arquès and Béraud's functional-differential equation for rooted oriented maps
...
for i in range(max):
    B[i+1] = x + z*B[i]*B[i] + z*B[i] + 2*z^2*derivative(B[i],z)
    B[i+1] = B[i+1].truncate(z,max)
   
B[max].subs(x=1)
# 302625067295157128042954*z^19 + 7734158085942678174730*z^18 + 208256802758892355202*z^17 + 5925085744543837186*z^16 + 178676789473121834*z^15 + 5731249477826890*z^14 + 196316804255522*z^13 + 7213364729026*z^12 + 285764591114*z^11 + 12277827850*z^10 + 576037442*z^9 + 29752066*z^8 + 1708394*z^7 + 110410*z^6 + 8162*z^5 + 706*z^4 + 74*z^3 + 10*z^2 + 2*z + 1
